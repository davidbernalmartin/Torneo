...
from ._utils import fetch_img as _fetch_img, draw_shield_centered as _draw_shield_centered, RFFM_LOGO_URL, LIGHT_BG, BORDER
...
def _draw_shield(c, img, cx: float, cy: float, size: float):
    _draw_shield_centered(c, img, None, cx, cy, size)
